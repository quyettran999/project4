...
<div class="container">
	<div class="breadcrumb" style="box-shadow: 1px 1px 5px #888888;">
		<div>
			<frm:form action="/editPost" modelAttribute="post" enctype="multipart/form-data" Method="POST">
				<div class="form-group">
					<div class="col-sm-10">
						<label for="title" style="font-weight: bold;">Title:</label>
						<frm:input path="title" class="form-control input-sm" id="title" type="text" vaule="${post.title}" />
					</div>
				</div> 
				<div class="form-group">
					<div class="col-sm-10">
						<label for="description" style="font-weight: bold;">Description:</label>
						<frm:input path="description" class="form-control input-sm" id="description" type="text" vaule="${post.description}" />
					</div>
				</div>
				<div class="form-group">
					<div class="col-sm-10">
						<label for="tang" style="font-weight: bold;">Content</label>
						<frm:textarea path="content" class="form-control" id="content" vaule="${post.content}"></frm:textarea>
					</div>
				</div>
				<div class="form-group">
					<div class="col-sm-10">
				...
				<frm:hidden path="id" id="id" vaule="${post.id}" />			
				<div class="container">
					<frm:button type="submit" class="btn btn-success btn-xs">Save</frm:button>
					<a class="btn btn-secondary btn-xs"href="post_management">back</a>
				</div>
